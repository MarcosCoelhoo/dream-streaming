...
export default async function initCreatePopularMovie() {
  const baseUrl = "https://api.themoviedb.org/3",
    imageUrl = "https://image.tmdb.org/t/p/w780",
    apiKey = "25ea17bf3ab54060fea05921b6061c3c";

  const popularMovieList = document.querySelector("#movie-popular .movie-list");
